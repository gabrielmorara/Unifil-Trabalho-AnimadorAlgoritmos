    ...
    public void onBtnCarregarPressionado() {
        ...
        switch (algoritmo) {
            ...
            case "Busca sequencial":
                ...
                break;
            case "Busca binária":
                int x = Integer.parseInt(txfEntradaChaveBusca.getText());
                novoFilme = AlgoritmosAnimados.buscaBinaria(valores, x);
                break;
            case "Bolha":
            ...
            case "Inserção" :
                ...
                break;
            case "Mergesort" :
                novoFilme = AlgoritmosAnimados.ordenarPorMergesort(valores, 0 , valores.size());//passa para metodo mergeSort direto
                break;
            case "Quicksort" :
